...
export const usersData = [{
  ...
  bio: 'Web Developer | Coffee Lover ☕ | Hiker 🏞️',
  followers: 1500,
  following: 300,
  posts: [
    {
      ...
      description: 'Success is no accident. It is hard work, perseverance, learning, studying, sacrifice and most of all, love of what you are doing or learning to do." — Pele, Brazilian soccer player',
      likes: 5,
      comments: 2,
      status: 'Private',
      timestamp:'9 Jul'
    },
    {
      ...
      description: 'Weekend vibes at the historical place! 🏖️🌞',
      likes: 38,
      comments: 22,
      status: 'Friends',
      timestamp:'3 Sep',
...
},
{
  ...
  bio: 'Web Developer | Tea Lover ☕ | Rider 🏞️',
  followers: 2400,
  following: 100,
  posts: [
    {
      ...
      description: 'Exploring nature today! 🌲🌳',
      likes: 5,
      comments: 2,
      status: 'Private',
      timestamp: '6 Jul'
